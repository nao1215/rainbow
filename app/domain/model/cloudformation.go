...
const (
	...
	// ResourceCreationCancelled is the message for resource creation cancelled.
	ResouceCreationCancelled = "Resource creation cancelled"
)
...
// HookInvocationPoint are points in provisioning logic where hooks are initiated.
type HookInvocationPoint string

// HookStatus provides the status of the change set hook.
type HookStatus string

// StackEvent is a CloudFormation stack event. It is same as types.StackEvent.
type StackEvent struct {
	// EventID is The unique ID of this event.
	EventID *string
	// StackID is the unique ID name of the instance of the stack.
	StackID *string
	// StackName is the name associated with a stack.
	StackName *string
	// Timestamp is time the status was updated.
	Timestamp *time.Time
	// ClientRequestToken is the token passed to the operation that generated this event. All events
	...
	// HookInvocationPoint is invocation points are points in provisioning logic where hooks are initiated.
	HookInvocationPoint HookInvocationPoint
	// HookStatus is provides the status of the change set hook.
	HookStatus HookStatus
	// HookStatusReason provides the reason for the hook status.
	HookStatusReason *string
	// HookType is the name of the hook.
	HookType *string
	// LogicalResourceID is the logical name of the resource specified in the template.
	LogicalResourceID *string
	// PhysicalResourceID is the name or unique identifier associated with the physical instance of the resource.
	PhysicalResourceID *string
	// ResourceProperties is BLOB of the properties used to create the resource.
